                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="page-header-breadcrumb">
                                                            <ul class="breadcrumb-title">
                                                                ...
                                                                <li class="breadcrumb-item" style="float: left;"><a href="#!">Assets maintenance Report</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card">
                                                            ...
                                                            <div class="card">
                                                                <div class="card-header">
                                                                    <h5>Assets maintenance Report</h5>
...
<option>Excel</option>
                                                                            ...
                                                                            <button type="submit" name="asset_maitaince_report" class="btn btn-primary btn-round align-text center">Generate</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
