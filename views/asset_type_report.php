                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="page-header-breadcrumb">
                                                            <ul class="breadcrumb-title">
                                                                ...
                                                                <li class="breadcrumb-item" style="float: left;"><a href="#!">Asset Types Report</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
...
<option>Excel</option>
                                                                            ...
                                                                            <button type="submit" name="asset_type_report" class="btn btn-primary btn-round align-text center">Generate</button>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                                </div>
